...
<?php } ?>
                        ...
                        <div class="col-lg-12 my-content">
                            ...
                            <div class="col-lg-4 my-resume-content box box-info">
                                ...
                                <div>
                                    ...
                                    <div style="margin-left: 10%; margin-top: 7%; margin-right: 10%;"> <h1 style="margin-left:3%;">Users
                                                                </h1><hr>  
                    ...
                    // for loop para sa pagkuha ng data
                                     ...
                                     ?>   
                                            ...
                                            <td><?php echo  $dats['username']; ?></td>
                                            <td><?php echo $dats['password']; ?> </td>
                                            <td><?php echo $dats['tme1']; ?> </td>
                                            <td>
                                                 <form action="<?php echo base_url('admin/viewuser/' )?>" method="POST">
                                                    <input type="text" style="display: none;" value="<?php echo $dats['contestantID']; ?>" name="id">
                                                    <input type="submit" value="View User" class="btn btn-info">
                                                    </form>
                                                </td>
